                    ...
                    <tbody>
                        {subjectMarks && subjectMarks.length > 0 && subjectMarks.map((subject, index) => (
                            <tr className="border" key={index}>
                                {termData?.allSubjects && (termData?.allSubjects).length > 0 && <td>
                                    {termData?.allSubjects[index].length <= 8 ? (
                                        termData?.allSubjects[index] // Display the full subject if it's 8 characters or less
                                    ) : (
                                        <>
                                            {termData?.allSubjects[index].slice(0, 8)}...{/* Display the first 8 characters followed by ellipsis */}
                                        </>
                                    )}
                                </td>
                                }
